...
export default function PowerPointToPdfPage() {
  const {
    ...
    minFiles: 1,
    defaultOutputName: 'presentation-converted.pdf',
  })
    ...
    <div className="relative min-h-screen bg-parchment-100 text-artisan-ink paper-grain">
      ...
      <div className="relative">
        ...
        <main className="mx-auto w-full max-w-3xl px-4 pb-24 pt-14 sm:px-6 sm:pt-20">
          <PageHeader
            eyebrow="PowerPoint to PDF"
            title="Convert PowerPoint slides to"
            highlight="PDF document"
            subtitle="Convert PowerPoint (.pptx, .ppt) presentations into clean, portable PDF documents."
          />
                ...
                <>
                  {files.length === 0 ? (
                    <UploadZone
                      ...
                      title="Drag & drop your PowerPoint presentation here"
                    />
                  ) : (
                    <UploadZone
                      compact
