...
export default function SplitPage() {
  ...
  const {
    ...
    endpoint: '/split',
    minFiles: 1,
    defaultOutputName: 'split-extracted.pdf',
  })
    ...
    <div className="relative min-h-screen bg-background">
      ...
      <div className="relative">
        ...
        <main className="mx-auto w-full max-w-3xl px-4 pb-24 pt-14 sm:px-6 sm:pt-20">
          <PageHeader
            eyebrow="Split PDF"
            title="Separate pages from"
            highlight="your PDF"
            subtitle="Extract specific page ranges or split every page into standalone documents in seconds."
          />
                    ...
                    <>
                      ...
                      <div className="mt-6 rounded-2xl border border-border bg-card/40 p-4 backdrop-blur-xl">
                        <label className="block text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                          Page Selection (e.g. "1-3, 5, 7" or "all")
                        </label>
                        <input
                          type="text"
                          value={pagesStr}
                      ...
                      <div className="mt-6 flex justify-center">
                        <button
                          type="button"
                          disabled={!canExecute}
                          onClick={() => executeTool({ pages: pagesStr })}
